...
const SUBTITLES: Record<RoadmapPeriod, string> = {
  'mar': '경쟁강도 · 소개서 신규 항목 · 수업료 납부 요청서 · 현금영수증 · 학원법 대응',
...
const DESCRIPTIONS: Record<RoadmapPeriod, string> = {
  'mar': '공고에 경쟁강도 도입, 소개서 신규 항목(수업 요일/시간대·수업 목적·자신있는 파트), AI 자연어 검색, 수업료 납부 요청서 자동발송, 현금영수증 자동발급, 학원법 개정 대응. 4/13 배포 완료.',
